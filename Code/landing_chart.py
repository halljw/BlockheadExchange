...
class FileWork(object):
	...
	def create_chart(self, input_file, coin_name, btc_file):
		#dataset1 setup
		...
		print (fourteen_bottom.head())
		print(fourteen_bottom)
